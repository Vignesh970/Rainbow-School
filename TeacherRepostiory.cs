...
{
    class TeacherRepostiory
    {
        List<TeacherModel> teachers;
        public TeacherRepostiory()
        {
            this.teachers = new List<TeacherModel>
                {
                new TeacherModel { Tid = 101, Tname = "Vignesh", Tclass = "Maths", Tsection = "A" },
                new TeacherModel { Tid = 102, Tname = "Sathya", Tclass = "CSE", Tsection = "B" },
                new TeacherModel { Tid = 103, Tname = "Sathish", Tclass = "Civil", Tsection = "A" },
                new TeacherModel { Tid = 104, Tname = "Siva", Tclass = "EEE", Tsection = "A" },
                new TeacherModel { Tid = 105, Tname = "Jaishankar", Tclass = "ECE", Tsection = "B" }
            };
        }
        public void StoreTeachersList()
        {
            StreamWriter fname = new StreamWriter("d:/TeacherRecord.txt");
        ...
        {
            StreamReader sr = new StreamReader(@"d:/TeacherRecord.txt");
        ...
        {
            StreamReader sr = new StreamReader("d:TeacherRecord.txt", true);
            string msg = sr.ReadToEnd();
            sr.Close();
        ...
        {
            StreamWriter fname = new StreamWriter(@"d:/TeacherRecord.txt", true);
            fname.WriteLine($"{s.Tid} {s.Tname} {s.Tclass} {s.Tsection}");
            fname.Close();
        }
    }
